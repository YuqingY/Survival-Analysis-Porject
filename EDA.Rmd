...
```
##Introduction
  For patients carrying human immunodeficiency virus type 1 (HIV-1), perhaps the most important question for them is how can they prolong their life before the de. 
...
aids.aic1 %>% glance()
```
####3.1 Interpretation of the coefficients and model results
