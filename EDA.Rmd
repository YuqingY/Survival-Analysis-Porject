...
##Introduction
  ...
  We choose to use a Cox proportional hazard model to predict the time to event. We use the AIC method for model selection and assume proportional hazard.
