...
##Introduction
  ...
  We choose to use a cox proportional harzard model to predict the time to event. We use AIC method for model selection, and assume proportional hazard, which is also tested in the report.
